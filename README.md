...
* 🔭 Currently working on **[Lipika AI](https://lipikaai.com/)** at **[Iterosys](https://iterosys.com/)** and **Lockton People Solutions** via **[AGT Software Partners](https://allgentech.io/)**
...
* 📫 **[Email](mailto:ahmedabir.rez@gmail.com)** · **[LinkedIn](https://www.linkedin.com/in/rezoan-abir/)**
...
**Languages**
Python · Go · C/C++ · JavaScript/TypeScript

**Backend & Application**
FastAPI · Node.js · Gin · PostgreSQL · Redis · RabbitMQ

**AI Engineering**
LangChain · LangGraph · RAG · Vector Search · LLM Tooling & Agent Workflows

**Cloud & Infrastructure**
AWS · GCP · Kubernetes · Docker · Terraform · GitHub Actions · Harness CI/CD

**AWS**
Lambda · Step Functions · Bedrock · EC2 · S3 · RDS · ECR · VPC · IAM · Secrets Manager

**GCP**
GKE · GCS · IAM · VPC

**Systems**
Linux · eBPF/XDP · KVM/QEMU · Firecracker · gVisor · Container & Network Isolation
...
| Project                                                        | Description                                                                                                         |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **[lb-xdp-poc](https://github.com/REZ0AN/lb-xdp-poc)**         | Experimental load balancer using eBPF/XDP and Go to explore high-performance packet processing.                     |
| **[xdp-tutorials](https://github.com/REZ0AN/xdp-tutorials)**   | Hands-on exploration of XDP and eBPF using C and Go, documenting concepts through progressively deeper experiments. |
| **[SimpleBank](https://github.com/REZ0AN/SimpleBank)**         | Backend banking API built with Go, Gin, SQLC, PostgreSQL, authentication, and containerized deployment.             |
| **[NutriNavigator](https://github.com/REZ0AN/NutriNavigator)** | Nutrition recommendation system combining personalized food recommendations with an organic food marketplace.       |
